---
description: Writes and runs tests for a specific expense tracker feature. Pass the spec name as argument e.g. /test-feature 05-backend-connection
...
Invoke the **expense-tracker-test-writer** subagent with the 
following context:
...
**expense-tracker-test-runner** subagent with the following 
context:
